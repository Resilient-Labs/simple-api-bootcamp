...
fetch(url)
    ...
    .then(data => {
        console.log(data)
        document.querySelector('.combat').innerText = data.powerstats.combat
        document.querySelector('.durability').innerText = data.powerstats.durability
        document.querySelector('.intelligence').innerText = data.powerstats.intelligence
        document.querySelector('.power').innerText = data.powerstats.power
        document.querySelector('.speed').innerText = data.powerstats.speed
