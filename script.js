...
document.querySelector("#countryButton").addEventListener("click",() => {
  ...
  let latitiude,longitude
  parseLatLong(countryIndex)
...
// })
//checkCountry()
// trees.forEach((el,i) => {console.log(el,i)})
...
//PRINTS LATITUDE LONGITUDE
// const checkCountry= () => {
//   gps.forEach(
//     (el,i) => {
//       console.log(el.country_code,i)
//     }
//   )
// }
//
...
// returnCountryIndex("VU")


function parseLatLong(countryIndex){
  latitiude = gps[countryIndex].latlng[0]
  longitude = gps[countryIndex].latlng[1]
